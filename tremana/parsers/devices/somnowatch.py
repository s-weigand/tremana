...
from tremana.util.dataframe_helper import extract_position_by_value
...
def _somnowatch_validate_meta_data(
    ...
    metadata_df.drop(ignore_signal_types, axis=0, inplace=True)
    most_common: pd.Series = metadata_df.mode().squeeze()
