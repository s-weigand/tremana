...
def fft_spectra(
    ...
    """Calculate the FFT of a accelerometry data.
...
def power_density_spectra(
    ...
    """Calculate the power density spectra of a accelerometry data.

    Compared to the FFT the resulting values FFT[-freq]*FFT[freq].
